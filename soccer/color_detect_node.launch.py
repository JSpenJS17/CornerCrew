...
def launch_setup(context):
    ...
    if compiled == 'True':
        ...
        soccer_package_path = get_package_share_directory('soccer')
    else:
        controller_package_path = '/home/ubuntu/ros2_ws/src/driver/controller'
        kinematics_package_path = '/home/ubuntu/ros2_ws/src/driver/kinematics'
        soccer_package_path = '/home/ubuntu/ros2_ws/src/soccer'
    ...
    color_detect_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(soccer_package_path, 'soccer/color_detect/color_detect_node.launch.py')),
        launch_arguments={
